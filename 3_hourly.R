...
# Dataframe 3: Ranks 201-300
df3 <- coin_list_all %>% filter(cmc_rank >= 201 & cmc_rank <= 300)



##

hourly_all_coins<-crypto_history(coin_list = df3,convert = "USD",limit = 100, interval= "1h",
