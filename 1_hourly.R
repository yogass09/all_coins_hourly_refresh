...
# Dataframe 1: Ranks 1-2500
df1 <- coin_list_all %>% filter(cmc_rank >= 1 & cmc_rank <= 100)


##

hourly_all_coins<-crypto_history(coin_list = df1,convert = "USD",limit = 100, interval= "1h",
