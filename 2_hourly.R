...
# Dataframe 2: Ranks 101-200
df2 <- coin_list_all %>% filter(cmc_rank >= 101 & cmc_rank <= 200)

##

hourly_all_coins<-crypto_history(coin_list = df2,convert = "USD",limit = 100, interval= "1h",
