...
# Dataframe 4: Ranks 301-400
df4 <- coin_list_all %>% filter(cmc_rank >= 301 & cmc_rank <= 400)


##

hourly_all_coins<-crypto_history(coin_list = df4,convert = "USD",limit = 100, interval= "1h",
