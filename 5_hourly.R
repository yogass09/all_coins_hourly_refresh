...
# Dataframe 5: Ranks 401-500
df5 <- coin_list_all %>% filter(cmc_rank >= 401 & cmc_rank <= 500)


##

hourly_all_coins<-crypto_history(coin_list = df5,convert = "USD",limit = 100, interval= "1h",
